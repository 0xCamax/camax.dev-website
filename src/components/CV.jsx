			...
			<Section
				...
				content={
					<>
						<ul>
							<li>
								Soy un desarrollador backend especializado en blockchain y DeFi,
								con experiencia en la implementación de soluciones para la
								optimización de operaciones y rendimientos.
							</li>
							<li>
								Desde 2020, trabajo de manera independiente optimizando
								contratos inteligentes, integrando protocolos descentralizados y
								analizando tendencias del sector.
							</li>
							<li>
								Mi enfoque combina la programación, analisis de riesgos y
								análisis de datos para innovar en el ámbito de las aplicaciones
					...
					<>
						...
						<ul style={{ listStyle: "circle", paddingLeft: 20 }}>
							<li>
								<ul>
									<li>
										Diseño y optimización de contratos inteligentes en Solidity.
									</li>
									<li>
										Análisis de datos blockchain con herramientas como TheGraph.
									</li>
									<li>
										Implementación de estrategias para mejorar la eficiencia en
										aplicaciones DeFi.
									</li>
									<li>
			...
			<Section
				...
				content={
					<>
						<ul style={{ listStyle: "circle", paddingLeft: 20 }}>
							<li>
								Curso la licenciatura en Ingeniería en Sistemas Computacionales,
								TecNM
							</li>
							<li>Ingles Fluido</li>
						</ul>
